        ...
        <div v-if="authStore.isAdmin" class="mb-4">
          ...
          >
            ...
            <span
              ...
              class="ml-auto px-2 py-0.5 text-xs font-bold bg-blue-600 text-white rounded-full animate-pulse"
            >
              {{ updateStore.updateCount }}
            </span>
          </RouterLink>
        </div>
      </nav>
...
onMounted(() => {
  ...
  // Initialize update store (check for updates at login + periodic check)
