...
final class Application
{
    ...
    public function getBackupSourceRepository(): BackupSourceRepository
    {
        return $this->getService(BackupSourceRepository::class, fn() =>
            new BackupSourceRepository($this->connection)
        );
    }
